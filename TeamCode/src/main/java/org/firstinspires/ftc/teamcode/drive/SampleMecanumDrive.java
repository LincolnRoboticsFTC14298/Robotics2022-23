...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        gvfFollower = new HolonomicGVFFollower(DriveConstants.MAX_VEL, DriveConstants.MAX_ACCEL, DriveConstants.GVF_ERROR, DriveConstants.kN, DriveConstants.kOmega);
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, RobotConfig.driveLeftFront);
        leftRear = hardwareMap.get(DcMotorEx.class, RobotConfig.driveLeftRear);
        rightRear = hardwareMap.get(DcMotorEx.class, RobotConfig.driveRightRear);
        rightFront = hardwareMap.get(DcMotorEx.class, RobotConfig.driveRightFront);
